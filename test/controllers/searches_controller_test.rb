...
class SearchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create search" do
    assert_difference('Search.count') do
      post searches_url, params: { search: { bairro: @search.bairro, logradouro: @search.logradouro, numero: @search.numero } }
    end
  ...
  test "should update search" do
    patch search_url(@search), params: { search: { bairro: @search.bairro, logradouro: @search.logradouro, numero: @search.numero } }
